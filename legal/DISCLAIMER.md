# Disclaimer of Warranty and Liability — monorepo
...
**Limitation of Liability.** To the fullest extent permitted by law, XXX_AUTHOR_FULL and contributors shall **not** be liable for any damages (including direct, indirect, incidental, special, exemplary, or consequential) arising from the use of, inability to use, or performance of the Project, even if advised of the possibility of such damages.
...
This repository is a **project** and **is not, by itself, a product placed on any market**. Publishing this repository does **not** make XXX_AUTHOR_FULL a “manufacturer” under product-safety or cybersecurity regimes.
...
Where XXX_AUTHOR_FULL distributes **commercial binaries**, obligations (including security support and vulnerability handling) are addressed in the accompanying documents: see `SECURITY` and `SUPPORT`.
...
Where required by applicable law (e.g., the **EU Accessibility Act**), we aim to address **accessibility feedback** for distributed binaries **within reasonable and proportionate limits**. Contact: **XXX_ACCESSIBILITY_EMAIL**. This section **does not** create service levels or guarantees.
...
**Governing Law.** Subject to mandatory consumer protection laws, this disclaimer is governed by the laws of **XXX_GOVERNING_LAW_COUNTRY** with venue in **XXX_GOVERNING_VENUE**.
