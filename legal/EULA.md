# End User License Terms — monorepo
...
**Accessibility.** Where required by law, we aim to address **accessibility feedback** for officially published artifacts **within reasonable and proportionate limits**. Contact: **XXX_ACCESSIBILITY_EMAIL**. This section does **not** create service levels or guarantees.
