# Privacy Notice — monorepo

**Effective date:** XXX_START_DATE

**Controller:** XXX_AUTHOR_FULL — Contact: XXX_PRIVACY_EMAIL

**Scope / Identification.** This notice applies to the **open-source project** **monorepo** (hosted on or mirrored to **public code hosting platform(s)**). We do **not** operate a consumer service through this repository.
...
If you email **XXX_SUPPORT_EMAIL**, we process your **email address**, **message content**, and any information you provide to respond.
