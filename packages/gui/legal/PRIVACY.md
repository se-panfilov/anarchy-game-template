...
**Scope / Identification.** This notice applies to the **open-source project** **gui** (hosted on or mirrored to **public code hosting platform(s)**). We do **not** operate a consumer service through this repository.
