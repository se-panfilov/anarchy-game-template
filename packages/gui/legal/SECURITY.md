...
This policy applies to the open-source project **gui** (the “Project”). It is provided for community coordination only and **does not create service levels (SLAs), warranties, or contractual obligations**.
...
**Technical identifiers (optional):** `gui`.
