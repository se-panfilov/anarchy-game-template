# Instructions & Support — XXX_GAME_NAME

**Effective date:** XXX_START_DATE

**Publisher/Developer:** XXX_AUTHOR_FULL

**Support contact:** XXX_SUPPORT_EMAIL

> This document provides basic use, safety, and compliance information for **XXX_GAME_NAME** (the “Software”). It does **not** create service levels, warranties, or contractual obligations. For license terms, see **EULA** (`EULA.*`). For privacy, see **Privacy Policy** (`PRIVACY.*`). For security and updates, see **Security Policy** (`SECURITY.*`).
...
- **OS:** Windows 10/11 (64-bit), macOS 12+ (Intel/Apple Silicon), or Linux x86_64 (e.g., Ubuntu 20.04+)
...
- **Software Bill of Materials** — `SBOM_POINTER.md` (full SBOM available on request) or at `../compliance/sbom/`
