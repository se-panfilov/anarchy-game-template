...
**First EU placement on the market:** XXX_INITIAL_RELEASE_DATE
...
**Cost:** security fixes are provided **free of charge** during the support period. Functionality/content updates are described in release notes (if any).
