...
import { GameDisplayName, SoftwareFamilyName, SupportedPlatforms, SystemRequirements } from '../../packages/shared/src/Legal/LegalConstants.js';
...
export default {
  ...
  GENERIC: {
    ...
    messages: {
      ...
      MIN_SYSTEM_REQUIREMENTS: SystemRequirements.Web.Minimum,
      REC_SYSTEM_REQUIREMENTS: SystemRequirements.Web.Recommended,
