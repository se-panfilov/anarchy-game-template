# Security Policy — XXX_GAME_NAME

**Effective date:** XXX_START_DATE

**Security Contact:** XXX_SECURITY_EMAIL

## Scope

This policy applies to commercial builds of **XXX_GAME_NAME** (the “Software”). It explains how to report potential security issues and how we handle them. **It does not create service levels, warranties, or contractual obligations.** Distribution and updates may occur via any **distribution channels** in use from time to time (including installers, physical media, or package archives).

## Coordinated Vulnerability Disclosure (CVD)

- **Report:** email **XXX_SECURITY_EMAIL**. Include affected version/platform, minimal reproduction steps, impact, and (if possible) a small PoC.
...
**Governing Law:** subject to mandatory law, matters under this policy are handled under **XXX_GOVERNING_LAW_COUNTRY/XXX_GOVERNING_VENUE**.
